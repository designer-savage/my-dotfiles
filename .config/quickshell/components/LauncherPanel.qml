                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            Rectangle {
                                ...
                                color: refreshAppMa.containsMouse ? Qt.rgba(1,1,1,0.1) : "transparent"
                                Text {
                                    anchors.centerIn: parent
                                    text: "󰑓"
                                    color: root.walColor8
                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            Rectangle {
                                width: 28; height: 28; radius: 8
                                color: refreshWallMa.containsMouse ? Qt.rgba(1,1,1,0.1) : "transparent"
                                Text {
                                    anchors.centerIn: parent
                                    text: "󰑓"
                                    color: root.walColor8
                                        ...
                                        Item {
                                            ...
                                            Rectangle {
                                                ...
                                                Image {
                                                    id: wallThumbImage
                                                    anchors.fill: parent
                                                    source: wallThumbImage.thumbHash.length > 0 ? "file://" + Quickshell.env("HOME") + "/.cache/wallpaper-thumbs/" + wallThumbImage.thumbHash + ".jpg" : ""
